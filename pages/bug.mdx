...
这个断连的问题和后摩服务器相关，建议通过 modelscope 下载相关的模型资源。同模型的 URL

https://www.modelscope.cn/models/Houmo/xh2_qwen3-vl_30b_a3b_8k

下载好之后再参考 https://developer.houmoai.com/hmdoc/lanyue/software/latest/hlie/hliellama/hliellama2.0.0/output.html#id10 
